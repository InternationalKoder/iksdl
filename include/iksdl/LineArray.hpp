...
/// \see Line
/////////////////////////////////////////////////
class LineArray : public Drawable
{
    public:
        ...
        /////////////////////////////////////////////////
        IKSDL_EXPORT explicit LineArray(Color color);
        ...
        /// \param color     Drawing color for all the lines
        /////////////////////////////////////////////////
        IKSDL_EXPORT LineArray(const std::vector<Positioni>& positions, Color color);
    ...
    private:
        ...
        std::vector<SDL_Point> m_points; ///< Points defining the connected lines
