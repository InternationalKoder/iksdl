...
#ifndef IKSDL_LINE_ARRAY_HPP
#define IKSDL_LINE_ARRAY_HPP
...
/////////////////////////////////////////////////
/// \brief An array of connected lines that can be drawn
///
/// This is the recommended approach when drawing several connected lines.
/// It is faster than drawing all the lines individually,
/// since only one single call is made to draw all the lines.
///
/// \warning All the lines in the array are drawn with the same color
///
/// \see Line
/////////////////////////////////////////////////
template<DrawablePosition T>
class BaseLineArray : public Drawable
{
    public:
        ...
        ///
        /// \param color Drawing color for all the lines
        /////////////////////////////////////////////////
        explicit BaseLineArray(Color color) :
        ...
        ///
        /// \param positions Points that define the connected lines to draw
        /// \param color     Drawing color for all the lines
        /////////////////////////////////////////////////
        BaseLineArray(const std::vector<T>& positions, Color color) :
            m_color(std::move(color))
        {
            m_points.reserve(positions.size());
            std::transform(positions.begin(), positions.end(), std::back_inserter(m_points), BaseLineArray::positionToSdl);
        }
        ...
        /////////////////////////////////////////////////
        /// \brief Change the position of the point at the given array index
        ///
        ...
        /////////////////////////////////////////////////
        /// \brief Change the drawing color of all the lines
        ///
        ...
        /////////////////////////////////////////////////
        /// \brief Draw all the connected lines
        ///
        ...
        virtual void draw(SDL_Renderer* const renderer) const
        {
            ...
            if constexpr(std::is_same_v<T, Positioni>)
                ...
                SDL_RenderDrawLinesF(renderer, m_points.data(), static_cast<int>(m_points.size()));
        }
    ...
    private:
        ...
        std::vector<CondSDL_Point> m_points; ///< Points defining the connected lines
        Color m_color;                       ///< Drawing color
};

using LineArray  = BaseLineArray<Positioni>; ///< Line array using \c int coordinates
using LineArrayf = BaseLineArray<Positionf>; ///< Line array using \c float coordinates

}

#endif // IKSDL_LINE_ARRAY_HPP
