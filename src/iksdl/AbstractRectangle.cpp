...
namespace iksdl
{
AbstractRectangle::AbstractRectangle(const Recti& rect, Color color) :
    m_rect{ .x = rect.getX(), .y = rect.getY(), .w = rect.getWidth(), .h = rect.getHeight() },
    m_color(std::move(color))
{}

AbstractRectangle::AbstractRectangle(const Positioni& position, const Sizei& size, Color color) :
